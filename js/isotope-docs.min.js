!(function(t, e) {
    ...
    function d(e) {
        if (
            ...
            for (
                var p = (h.isBorderBox = "border-box" == d.boxSizing), u = 0; u < g; u++
            ) {
                var f = a[u],
                    m = d[f],
                    s = parseFloat(m);
    ...
    return (
        ...
        (t.emitEvent = function(e, t) {
            ...
            if (n && n.length) {
                (n = n.slice(0)), (t = t || []);
                for (
                    var i = this._onceEvents && this._onceEvents[e], s = 0; s < n.length; s++
                ) {
                    var o = n[s],
                        f = i && i[o];
...
!(function(t, e) {
    ...
    (m._filter = function(t) {
        ...
        e = e || "*";
        for (
            var i = [], r = [], o = [], s = this._getFilterTest(e), n = 0; n < t.length; n++
        ) {
            var a = t[n];
            if (!a.isIgnored) {
                var u = s(a);
...
!(function(t, i) {
    ...
    return (
        ...
        (e._getHorizontalColPosition = function(t, i) {
            ...
            return (
                (this.horizontalColIndex = h ? o + t : this.horizontalColIndex), { col: o, y: this._getColGroupY(o, t) }
            );
        }),
...
!(function(t, e) {
    ...
    return (
        (r.prototype.addElementBackgroundImages = function(t) {
            ...
            if (e)
                for (
                    var i = /url\((['"])?(.*?)\1\)/gi, o = i.exec(e.backgroundImage); null !== o;
...
!(function(e) {
    ...
    function g(e, r, t) {
        var n = r ? M[r] : t,
            a = [e.trim()];
        return (
            e.match(/\bhljs\b/) || a.push("hljs"), -1 === e.indexOf(n) && a.push(n),
            a.join(" ").trim()
        );
    }
